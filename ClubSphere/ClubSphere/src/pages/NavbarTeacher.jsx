      ...
      <div className="hidden md:flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center text-white font-medium text-sm shadow-inner">
                {ID?.charAt(0) || "?"}
              </div>
            ...
            {isDropdownOpen && (
              <div className={`absolute right-0 mt-2 w-48 rounded-lg shadow-lg overflow-hidden ${
                ...
                <div className="p-3 border-b border-gray-200 dark:border-gray-700">
                  <p className="font-medium">{ID || "Loading..."}</p>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Teacher</p>
                </div>
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className={`absolute top-0 left-0 bottom-0 w-3/4 max-w-xs ${
            ...
            <div className="p-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center text-white font-medium shadow-inner">
                  {ID?.charAt(0) || "?"}
                </div>
                <div>
                  <p className="font-medium">{ID || "Loading..."}</p>
